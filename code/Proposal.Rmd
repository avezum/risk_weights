...
Bank level information is not enough to draw meaningful comparisons. We need loan-level data, that allow us to compare the exposure of two banks with different risk-weights for the same loan. This loan-level analysis, with flavor of Mian and khwaja, allow us to separate loand demand from supply effects and meaninfully infer and effect of differences in risk weight. 
